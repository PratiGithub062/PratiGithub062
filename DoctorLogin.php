		...
		<div class="row">
           ...
           <center>
            ...
            <div>
								...
								<form method="post" action="DoctorLoginCode.php" style="border-bottom: 4px solid #495786;">
                                <h2 style="background-color:#2A1F00;"><strong style="color:#FFFBF0;">Doctor Log-in</strong></h2><br />
									<div class="row uniform">
                                        
										<div>
									    <label>Email Id  :&nbsp;&nbsp;&nbsp;&nbsp;</label> <input type="text" name="username" id="username" value="" placeholder="User Name" />
										</div>
										...
										<input type="button" onClick="window.location.href='DoctorLogin.php'" value="Cancel" class="alt"/>
										
										</div>
                                        <div>
                                        <span id="nameerror" style="color: Red; display: none">* Enter Your Email Id </span>
